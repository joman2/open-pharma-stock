...
class Barcode {
  ...
  factory Barcode.fromNative(Map<Object?, Object?> data) {
    ...
    final Map<Object?, Object?>? track =
        data['track'] as Map<Object?, Object?>?;
  ...
  /// Whether the barcode geometry intersects the active scan window.
  final bool inScanWindow;
  ...
  /// Native tracking metadata when the platform exposes a primary tracked target.
  final BarcodeTrack? track;
...
class BarcodeTrack {
  ...
  factory BarcodeTrack.fromNative(Map<Object?, Object?> data) {
    final List<Object?>? corners = data['corners'] as List<Object?>?;
    final Map<Object?, Object?>? rect = data['rect'] as Map<Object?, Object?>?;
    final double? left = rect?['left'] as double?;
    final double? top = rect?['top'] as double?;
    final double? right = rect?['right'] as double?;
    final double? bottom = rect?['bottom'] as double?;

    return BarcodeTrack(
      id: data['id'] as String? ?? '',
      rect: left == null || top == null || right == null || bottom == null
          ? Rect.zero
      ...
      stableFrames: data['stableFrames'] as int? ?? 0,
      ageMs: data['ageMs'] as int? ?? 0,
    );
  }
