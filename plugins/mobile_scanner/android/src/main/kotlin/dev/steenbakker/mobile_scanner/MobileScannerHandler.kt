...
class MobileScannerHandler(
    ...
    private fun start(call: MethodCall, result: MethodChannel.Result) {
        ...
        val enableFallbackDecoder: Boolean =
            call.argument<Boolean>("enableFallbackDecoder") ?: false
        val debugDpmFrames: Boolean =
            call.argument<Boolean>("debugDpmFrames") ?: false
        ...
        val barcodeFormats: Set<BarcodeFormat>? = formats
            ?.mapNotNull { rawValue ->
                FossBarcodeValues.toZxingFormat(
                    BarcodeFormats.fromRawValue(rawValue).intValue,
                )
            }
            ?.toSet()
